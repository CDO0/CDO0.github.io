...
/*************************************
    ...
    *************************************/
this.add.image(this.game.renderer.width/2, this.game.renderer.height/1.85, "wantedAlternance").setDepth(0);
...
/*************************************
    *  liens
    *************************************/
const button = this.add.image(850, 200, "lien").setInteractive();
...
const contact = this.add.image(850,500, "contact").setInteractive();
...
openExternalLink ()
    {
        ...
        const url = `https://drive.google.com/file/d/1WyaRByqfmwZn6qsLto7dfIiMAj1gqvXu/view?usp=drive_link{encodeURIComponent()}`;
